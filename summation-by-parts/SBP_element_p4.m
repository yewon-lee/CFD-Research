%% SBP using element-type operators, p=4 (Q1.6) ops 1.75-1.77
...
% elements3 = 40;
% elements4 = 50;
% [u1 x1 err1 energy1 oneHu1 t1 dx1] = SBP_solver (a, tN, t0, x0, xN, sigma0, elements1);
% [u2 x2 err2 energy2 oneHu2 t2 dx2] = SBP_solver (a, tN, t0, x0, xN, sigma1, elements2);
% % [u3 x3 err3 energy3 oneHu3 t3 dx3] = SBP_solver (a, tN, t0, x0, xN, sigma1, elements3);
% % [u4 x4 err4 energy4 oneHu4 t4 dx4] = SBP_solver (a, tN, t0, x0, xN, sigma1, elements4);
% 
% % %plot
% % plot(x1,u1);
% % xlabel('x');
...
function[u x err energy oneHu t dx] = SBP_element_p4 (a, tN, t0, x0, xN, sigma, elements)
